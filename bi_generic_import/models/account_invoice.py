...
class gen_inv(models.TransientModel):
    ...
    def make_invoice(self, values):
        ...
        if invoice_search:
            ...
            inv_id = invoice_obj.with_context(Import=True).create({
            ...
            for i in main_list:
                ...
                if normal_details.startswith('x_'):
                    ...
                    if any_special:
                        ...
                        technical_fields_name = split_fields_name[0][2:]
    ...
    def make_invoice_line(self, values, inv_id):
        ...
        inv_id.with_context(Import=True).write({'invoice_line_ids' :([(0,0,vals)]) })
