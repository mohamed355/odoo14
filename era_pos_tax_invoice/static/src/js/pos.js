odoo.define('era_tax_invoice.OrderReceipt', function(require) {
    ...
    const pos_order_return_reprint = require('pos_order_return_reprint.pos_order_return');

//    models.load_fields('pos.config',['allow_qr_code']);
    pos_model.load_fields('pos.order', 'qr_code');
      ...
      module.Order = module.Order.extend({
        ...
        export_as_JSON: function() {
            ...
            if (self.pos.get_order() != null) {
              current_order.set_QRcode();
                loaded.qr_code = current_order.get_QRcode() || false;
            }
            return loaded;
        },
        set_QRcode:function() {
...
// //                    console.log(qr_code_data)
                    receipt_render_env.receipt.qr_code = order.get_QRcode();
                    // receipt_render_env.receipt.qr_code = qrCodeBase64;

                    // console.log("order",order);
                    // order.set_QRcode(qrCodeBase64);
